...
import { deleteUser } from "@/lib/client/db";
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropDownItem onClick={() => router.push(`/users/edit-user/${user.id}`)} module="users" level="edit">
                          Edit
                        </DropDownItem>
                        <DropDownItem className="text-red-600" onClick={() => handleDelete(user.id)} module="users" level="edit" disabled={currentUser === user.id}>
                          Delete
                        </DropDownItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
