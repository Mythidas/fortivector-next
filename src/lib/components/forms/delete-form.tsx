...
import { deleteFormSchema, DeleteFormValues, systemFormSchema, SystemFormValues } from "@/lib/schema/forms";
...
export default function DeleteForm({ id, cancel_route, submit_text, pending_text, action }: Props) {
